		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#commetimetisoftui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commetimetisoftui-display": {
								"semanticObject": "commetimetisoftui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.meti.metisoftui",
									"url": sap.ui.require.toUrl("com/meti/metisoftui")
								}
							}
						}
					}
